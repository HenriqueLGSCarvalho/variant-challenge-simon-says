...
The "Cosmetic Keybinds" are purely for extra customization on how a user's game appears to them, and provides no gameplay consequences. 
...
6. Complete!
    ```md 
    The game should now be opened and ready to play.
    ```
...
A specific example of me struggling with the Spine library was specifically the distinction between setAnimation() and addAnimation(). I was originally using setAnimation() for all of my instances of animations, which was causing severe issues with the fluidity of movements, and continuity of previous animations. After realizing this issue, I was able to make the necessary changes, and fixed most of the fluidity issues within this project. 
